...
// 7   карты Евроторга. Условия ЛС, ИМТ, ИМН – 1% ИД группы(1,5,6) остальное 5 процентов в пределах наценки
 ...
 while @@sqlstatus=0
  begin
    ...
    if @KindDiscont=1 or @KindDiscont=3 or @KindDiscont=4 or @KindDiscont=5 or @KindDiscont=6 or @KindDiscont=7
    ...
    if @KindDiscont!=3 and @KindDiscont!=4 and @KindDiscont!=6 and @gtWareCost<@gtPriceP-round(@gtPricePAll/(1+@gtVAT*0.01),2) 
